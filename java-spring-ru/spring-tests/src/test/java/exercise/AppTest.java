...
public class AppTest {
    ...
    void deletePerson() throws Exception {
        ...
        assertThat(responseGet.getContentAsString()).doesNotContain("\"firstName\":\"Jack\"");
    }
    ...
    void updatePerson() throws Exception {
        MockHttpServletResponse responsePatch = mockMvc
                .perform(
                        patch("/people/4")
                                .contentType(MediaType.APPLICATION_JSON)
                                .content("{\"firstName\": \"Jane\", \"lastName\": \"Austin\"}")
                )
                .andReturn()
                .getResponse();
        ...
        assertThat(responseGet.getContentAsString()).contains("Jane", "Austin");
    }
    // END
}

...
public class UserController {
    ...
    public User createUser(@RequestBody User user) {
        ...
        // BEGIN
        // при регистрации нового пользователя в очередь отправлялось сообщение о регистрации нового пользователя
    ...
    public void deleteUser(@PathVariable long id) {
        ...
        // BEGIN
        // при удалении пользователя в очередь отправлялось сообщение об удалении пользователя
        messageSender.sendMessage(message);
        // END
